...
public class NDNService extends Service {
    ...
    private static NDNService single = null;

    public static NDNService getInstance() {
        if (single != null)
            return single;
        return null;
    }

    public class NDNMonitorBinder extends Binder {
        NDNService getService() {
            return NDNService.this;
        }
    }

    private final IBinder mBinder = new NDNMonitorBinder();
    ...
    private Runnable mRefresh = new Runnable() {
        ...
        public void run() {
            ...
            String maininfo = "";
            //serviceContext.getResources().getString(R.string.process_cpuusage)+" "+cpuLoad+"% , "
...
/*                              serviceNotify.contentView.setTextViewText(R.id.StatusBarCPU, "CPU: "+cpuLoad+"%");
    ...
    private void InitNotification() {
        ...
        Intent notificationIntent = new Intent(this, NDNActivity.class);
