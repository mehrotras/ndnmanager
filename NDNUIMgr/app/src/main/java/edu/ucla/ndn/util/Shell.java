...
import edu.ucla.ndn.util.StreamGobbler.OnLineListener;

/**
 * Class providing functionality to execute commands in a (root) shell
 */
public class Shell {
    private static final String CLASS_TAG = "Shell";
    ...
    public static List<String> run(String shell, String[] commands, String[] environment,
        ...
        try {
            ...
            try {
                ...
                Log.e(CLASS_TAG, "IOE :" + e.getMessage());
            }
            STDOUT.join();
            STDERR.join();
            process.destroy();
            ...
            Log.e(CLASS_TAG, "INTE " + e.getMessage());
            res = null;
        }
